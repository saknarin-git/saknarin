    ...
    return (
      <div className="devmanager-section-stack">
        ...
        <section className="card">
          ...
          <div className="notice">คอลัมน์ที่รองรับ: เลขที่สมาชิก, เลขที่สัญญา, ยอดเงินกู้, ยอดคงค้าง, สถานะ, วันที่สร้างสัญญา, ผู้ค้ำประกันคนที่ 1, ผู้ค้ำประกันคนที่ 2 และข้อมูลชื่อจะใช้แบบแยกคอลัมน์ `คำนำหน้าชื่อ, ชื่อ, สกุล` หรือรวมอยู่คอลัมน์เดียวเป็น `ชื่อ-สกุล` เช่น `นาย สมชาย ใจดี` ก็ได้</div>
