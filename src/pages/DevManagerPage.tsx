    ...
    return (
      <div className="devmanager-section-stack">
        ...
        <section className="card">
          ...
          <div className="notice">คอลัมน์ที่รองรับ: เลขที่สมาชิก, เลขที่สัญญา, ยอดเงินกู้, ยอดคงค้าง, สถานะ, วันที่สร้างสัญญา, ผู้ค้ำประกันคนที่ 1 และผู้ค้ำประกันคนที่ 2 (ถ้ามีก็ใส่, ถ้าไม่มีก็เว้นว่างได้) ส่วนชื่อผู้กู้ใช้ได้ทั้งแบบแยกคอลัมน์ `คำนำหน้าชื่อ, ชื่อ, สกุล` หรือคอลัมน์เดียว เช่น `ชื่อ`, `ชื่อผู้กู้`, `ชื่อ-สกุล` โดยจะรองรับทั้ง `นาย สมชาย ใจดี`, `สมุด`, และชื่อหน่วยงานอย่าง `ล่องแก่ง`</div>
